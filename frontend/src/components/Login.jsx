...
const Login = () => {
  ...
  return (
    ...
    >
      <div className="min-h-screen w-[95%] mx-auto flex flex-col justify-center py-12 sm:px-6 lg-px-8">
        <div className="sm:w-full sm:mx-auto sm:max-w-md  w-[95%]  mx-auto ">
          <h2 className="mt-[20%] text-center text-4xl font-extrabold text-gray-900 uppercase">
            Đăng nhập
          </h2>
        </div>
        <div className="800px:w-full w-[90%] mx-auto sm:max-w-md mt-4">
